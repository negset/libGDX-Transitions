...
class SecondScreen(private val game: TransitionTest) : ScreenAdapter()
{
    private val tag = SecondScreen::class.java.simpleName

    private val stage = Stage(FitViewport(WIDTH, HEIGHT))
    private var paused = false

    private val texture = Texture("bg02.jpg")
